...
[@opcat-labs/cat-sdk](../README.md) / CAT20

# Class: CAT20

Defined in: [packages/cat-sdk/src/contracts/cat20/cat20.ts:29](https://github.com/OPCAT-Labs/ts-tools/blob/c228c7fe95bfef4336ddbadcd78e6f936189a844/packages/cat-sdk/src/contracts/cat20/cat20.ts#L29)
...
- `SmartContract`\<[`CAT20State`](../type-aliases/CAT20State.md)\>

## Constructors

### new CAT20()

> **new CAT20**(`minterScriptHash`, `guardScriptHash`): [`CAT20`](CAT20.md)

Defined in: [packages/cat-sdk/src/contracts/cat20/cat20.ts:36](https://github.com/OPCAT-Labs/ts-tools/blob/c228c7fe95bfef4336ddbadcd78e6f936189a844/packages/cat-sdk/src/contracts/cat20/cat20.ts#L36)
...
`SmartContract<CAT20State>.constructor`
...
> **\_state**: [`CAT20State`](../type-aliases/CAT20State.md)
...
Defined in: [packages/cat-sdk/src/contracts/cat20/cat20.ts:34](https://github.com/OPCAT-Labs/ts-tools/blob/c228c7fe95bfef4336ddbadcd78e6f936189a844/packages/cat-sdk/src/contracts/cat20/cat20.ts#L34)
...
Defined in: [packages/cat-sdk/src/contracts/cat20/cat20.ts:31](https://github.com/OPCAT-Labs/ts-tools/blob/c228c7fe95bfef4336ddbadcd78e6f936189a844/packages/cat-sdk/src/contracts/cat20/cat20.ts#L31)
...
> **asyncBindToUtxo**(`utxo`, `callback`): `Promise`\<[`CAT20`](CAT20.md)\>
...
> **checkGuard**(`guardState`, `t_cat20ScriptHash`, `t_cat20InputIndexVal`, `guardInputIndexVal`, `t_spentScriptsCtx`, `t_spentDataHashesCtx`): `void`

Defined in: [packages/cat-sdk/src/contracts/cat20/cat20.ts:75](https://github.com/OPCAT-Labs/ts-tools/blob/c228c7fe95bfef4336ddbadcd78e6f936189a844/packages/cat-sdk/src/contracts/cat20/cat20.ts#L75)

#### Parameters

##### guardState

[`CAT20GuardConstState`](../type-aliases/CAT20GuardConstState.md)

##### t\_cat20ScriptHash

`ByteString`

##### t\_cat20InputIndexVal
...
> **unlock**(`unlockArgs`, `guardState`, `guardInputIndex`, `backtraceInfo`): `void`

Defined in: [packages/cat-sdk/src/contracts/cat20/cat20.ts:43](https://github.com/OPCAT-Labs/ts-tools/blob/c228c7fe95bfef4336ddbadcd78e6f936189a844/packages/cat-sdk/src/contracts/cat20/cat20.ts#L43)

#### Parameters

##### unlockArgs

[`ContractUnlockArgs`](../type-aliases/ContractUnlockArgs.md)
