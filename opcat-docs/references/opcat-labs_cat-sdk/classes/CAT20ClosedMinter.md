...
[@opcat-labs/cat-sdk](../README.md) / CAT20ClosedMinter

# Class: CAT20ClosedMinter

Defined in: [packages/cat-sdk/src/contracts/cat20/minters/cat20ClosedMinter.ts:13](https://github.com/OPCAT-Labs/ts-tools/blob/c228c7fe95bfef4336ddbadcd78e6f936189a844/packages/cat-sdk/src/contracts/cat20/minters/cat20ClosedMinter.ts#L13)
...
- `SmartContract`\<[`CAT20ClosedMinterState`](../interfaces/CAT20ClosedMinterState.md)\>

## Constructors

### new CAT20ClosedMinter()

> **new CAT20ClosedMinter**(`ownerAddress`, `genesisOutpoint`): [`CAT20ClosedMinter`](CAT20ClosedMinter.md)

Defined in: [packages/cat-sdk/src/contracts/cat20/minters/cat20ClosedMinter.ts:20](https://github.com/OPCAT-Labs/ts-tools/blob/c228c7fe95bfef4336ddbadcd78e6f936189a844/packages/cat-sdk/src/contracts/cat20/minters/cat20ClosedMinter.ts#L20)
...
[`CAT20ClosedMinter`](CAT20ClosedMinter.md)

#### Overrides

`SmartContract<CAT20ClosedMinterState>.constructor`
...
> **\_state**: [`CAT20ClosedMinterState`](../interfaces/CAT20ClosedMinterState.md)
...
Defined in: [packages/cat-sdk/src/contracts/cat20/minters/cat20ClosedMinter.ts:18](https://github.com/OPCAT-Labs/ts-tools/blob/c228c7fe95bfef4336ddbadcd78e6f936189a844/packages/cat-sdk/src/contracts/cat20/minters/cat20ClosedMinter.ts#L18)
...
Defined in: [packages/cat-sdk/src/contracts/cat20/minters/cat20ClosedMinter.ts:15](https://github.com/OPCAT-Labs/ts-tools/blob/c228c7fe95bfef4336ddbadcd78e6f936189a844/packages/cat-sdk/src/contracts/cat20/minters/cat20ClosedMinter.ts#L15)
...
> **asyncBindToUtxo**(`utxo`, `callback`): `Promise`\<[`CAT20ClosedMinter`](CAT20ClosedMinter.md)\>
...
`Promise`\<[`CAT20ClosedMinter`](CAT20ClosedMinter.md)\>
...
> **mint**(`tokenMint`, `issuerPubKey`, `issuerSig`, `minterSatoshis`, `tokenSatoshis`, `backtraceInfo`): `void`

Defined in: [packages/cat-sdk/src/contracts/cat20/minters/cat20ClosedMinter.ts:27](https://github.com/OPCAT-Labs/ts-tools/blob/c228c7fe95bfef4336ddbadcd78e6f936189a844/packages/cat-sdk/src/contracts/cat20/minters/cat20ClosedMinter.ts#L27)
...
[`CAT20ClosedMinterState`](../interfaces/CAT20ClosedMinterState.md)
...
Defined in: [packages/cat-sdk/src/contracts/cat20/minters/cat20ClosedMinter.ts:79](https://github.com/OPCAT-Labs/ts-tools/blob/c228c7fe95bfef4336ddbadcd78e6f936189a844/packages/cat-sdk/src/contracts/cat20/minters/cat20ClosedMinter.ts#L79)
