...
[@opcat-labs/cat-sdk](../README.md) / CAT20Guard

# Class: CAT20Guard

Defined in: [packages/cat-sdk/src/contracts/cat20/cat20Guard.ts:34](https://github.com/OPCAT-Labs/ts-tools/blob/c228c7fe95bfef4336ddbadcd78e6f936189a844/packages/cat-sdk/src/contracts/cat20/cat20Guard.ts#L34)
...
- `SmartContract`\<[`CAT20GuardConstState`](../type-aliases/CAT20GuardConstState.md)\>

## Constructors

### new CAT20Guard()

> **new CAT20Guard**(...`args`): [`CAT20Guard`](CAT20Guard.md)

Defined in: node\_modules/@opcat-labs/scrypt-ts-opcat/dist/types/smart-contract/smartContract.d.ts:64
...
[`CAT20Guard`](CAT20Guard.md)

#### Inherited from

`SmartContract<CAT20GuardConstState>.constructor`
...
> **\_state**: [`CAT20GuardConstState`](../type-aliases/CAT20GuardConstState.md)
...
> **asyncBindToUtxo**(`utxo`, `callback`): `Promise`\<[`CAT20Guard`](CAT20Guard.md)\>
...
`Promise`\<[`CAT20Guard`](CAT20Guard.md)\>
...
> **unlock**(`nextStateHashes`, `ownerAddrOrScriptHashes`, `outputTokens`, `tokenScriptHashIndexes`, `outputSatoshis`, `cat20States`, `outputCount`): `void`

Defined in: [packages/cat-sdk/src/contracts/cat20/cat20Guard.ts:36](https://github.com/OPCAT-Labs/ts-tools/blob/c228c7fe95bfef4336ddbadcd78e6f936189a844/packages/cat-sdk/src/contracts/cat20/cat20Guard.ts#L36)
...
`FixedArray`\<`ByteString`, `10`\>

##### outputTokens

`FixedArray`\<`bigint`, `10`\>
...
`FixedArray`\<[`CAT20State`](../type-aliases/CAT20State.md), `10`\>
