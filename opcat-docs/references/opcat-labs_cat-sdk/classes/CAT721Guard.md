...
[@opcat-labs/cat-sdk](../README.md) / CAT721Guard

# Class: CAT721Guard

Defined in: [packages/cat-sdk/src/contracts/cat721/cat721Guard.ts:14](https://github.com/OPCAT-Labs/ts-tools/blob/c228c7fe95bfef4336ddbadcd78e6f936189a844/packages/cat-sdk/src/contracts/cat721/cat721Guard.ts#L14)
...
- `SmartContract`\<[`CAT721GuardConstState`](../type-aliases/CAT721GuardConstState.md)\>

## Constructors

### new CAT721Guard()

> **new CAT721Guard**(...`args`): [`CAT721Guard`](CAT721Guard.md)
...
[`CAT721Guard`](CAT721Guard.md)

#### Inherited from

`SmartContract<CAT721GuardConstState>.constructor`
...
> **\_state**: [`CAT721GuardConstState`](../type-aliases/CAT721GuardConstState.md)
...
> **asyncBindToUtxo**(`utxo`, `callback`): `Promise`\<[`CAT721Guard`](CAT721Guard.md)\>
...
`Promise`\<[`CAT721Guard`](CAT721Guard.md)\>
...
> **unlock**(`nextStateHashes`, `ownerAddrOrScriptHashes`, `outputLocalIds`, `nftScriptHashIndexes`, `outputSatoshis`, `cat721States`, `outputCount`): `void`

Defined in: [packages/cat-sdk/src/contracts/cat721/cat721Guard.ts:16](https://github.com/OPCAT-Labs/ts-tools/blob/c228c7fe95bfef4336ddbadcd78e6f936189a844/packages/cat-sdk/src/contracts/cat721/cat721Guard.ts#L16)
...
`FixedArray`\<[`CAT721State`](../type-aliases/CAT721State.md), `10`\>
