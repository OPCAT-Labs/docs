...
[@opcat-labs/cat-sdk](../README.md) / CAT721OpenMinter

# Class: CAT721OpenMinter

Defined in: [packages/cat-sdk/src/contracts/cat721/minters/cat721OpenMinter.ts:16](https://github.com/OPCAT-Labs/ts-tools/blob/c228c7fe95bfef4336ddbadcd78e6f936189a844/packages/cat-sdk/src/contracts/cat721/minters/cat721OpenMinter.ts#L16)
...
- `SmartContract`\<[`CAT721OpenMinterState`](../type-aliases/CAT721OpenMinterState.md)\>

## Constructors

### new CAT721OpenMinter()

> **new CAT721OpenMinter**(`genesisOutpoint`, `max`, `premine`, `preminerAddr`): [`CAT721OpenMinter`](CAT721OpenMinter.md)

Defined in: [packages/cat-sdk/src/contracts/cat721/minters/cat721OpenMinter.ts:29](https://github.com/OPCAT-Labs/ts-tools/blob/c228c7fe95bfef4336ddbadcd78e6f936189a844/packages/cat-sdk/src/contracts/cat721/minters/cat721OpenMinter.ts#L29)
...
[`CAT721OpenMinter`](CAT721OpenMinter.md)

#### Overrides

`SmartContract<CAT721OpenMinterState>.constructor`
...
> **\_state**: [`CAT721OpenMinterState`](../type-aliases/CAT721OpenMinterState.md)
...
Defined in: [packages/cat-sdk/src/contracts/cat721/minters/cat721OpenMinter.ts:18](https://github.com/OPCAT-Labs/ts-tools/blob/c228c7fe95bfef4336ddbadcd78e6f936189a844/packages/cat-sdk/src/contracts/cat721/minters/cat721OpenMinter.ts#L18)
...
Defined in: [packages/cat-sdk/src/contracts/cat721/minters/cat721OpenMinter.ts:21](https://github.com/OPCAT-Labs/ts-tools/blob/c228c7fe95bfef4336ddbadcd78e6f936189a844/packages/cat-sdk/src/contracts/cat721/minters/cat721OpenMinter.ts#L21)
...
Defined in: [packages/cat-sdk/src/contracts/cat721/minters/cat721OpenMinter.ts:24](https://github.com/OPCAT-Labs/ts-tools/blob/c228c7fe95bfef4336ddbadcd78e6f936189a844/packages/cat-sdk/src/contracts/cat721/minters/cat721OpenMinter.ts#L24)
...
Defined in: [packages/cat-sdk/src/contracts/cat721/minters/cat721OpenMinter.ts:27](https://github.com/OPCAT-Labs/ts-tools/blob/c228c7fe95bfef4336ddbadcd78e6f936189a844/packages/cat-sdk/src/contracts/cat721/minters/cat721OpenMinter.ts#L27)
...
> **asyncBindToUtxo**(`utxo`, `callback`): `Promise`\<[`CAT721OpenMinter`](CAT721OpenMinter.md)\>
...
`Promise`\<[`CAT721OpenMinter`](CAT721OpenMinter.md)\>
...
Defined in: [packages/cat-sdk/src/contracts/cat721/minters/cat721OpenMinter.ts:115](https://github.com/OPCAT-Labs/ts-tools/blob/c228c7fe95bfef4336ddbadcd78e6f936189a844/packages/cat-sdk/src/contracts/cat721/minters/cat721OpenMinter.ts#L115)
...
> **mint**(`nftMint`, `openMintInfo`, `proof`, `proofNodePos`, `preminerPubKey`, `preminerSig`, `minterSatoshis`, `nftSatoshis`, `backtraceInfo`): `void`

Defined in: [packages/cat-sdk/src/contracts/cat721/minters/cat721OpenMinter.ts:38](https://github.com/OPCAT-Labs/ts-tools/blob/c228c7fe95bfef4336ddbadcd78e6f936189a844/packages/cat-sdk/src/contracts/cat721/minters/cat721OpenMinter.ts#L38)
...
[`CAT721OpenMinterState`](../type-aliases/CAT721OpenMinterState.md)
