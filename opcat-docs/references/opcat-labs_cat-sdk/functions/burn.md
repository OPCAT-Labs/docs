...
[cat-sdk](../README.md) / burn

# Function: burn()

> **burn**(`signer`, `provider`, `minterScriptHash`, `inputTokenUtxos`, `feeRate`): `Promise`\<\{ `burnPsbt`: `ExtPsbt`; `burnTxid`: `string`; `guardPsbt`: `ExtPsbt`; `guardTxid`: `string`; \}\>
