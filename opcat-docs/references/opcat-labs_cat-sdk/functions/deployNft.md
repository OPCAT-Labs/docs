...
[cat-sdk](../README.md) / deployNft

# Function: deployNft()

> **deployNft**(`signer`, `provider`, `metadata`, `initMerkleRoot`, `feeRate`, `changeAddress`?): `Promise`\<[`CAT721NftInfo`](../interfaces/CAT721NftInfo.md)\<[`OpenMinterCAT721Meta`](../type-aliases/OpenMinterCAT721Meta.md)\> & `object`\>
