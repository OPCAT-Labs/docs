...
[@opcat-labs/cat-sdk](../README.md) / deployOpenMinterToken

# Function: deployOpenMinterToken()

> **deployOpenMinterToken**(`signer`, `preminerSigner`, `provider`, `metadata`, `feeRate`, `changeAddress`?): `Promise`\<[`CAT20TokenInfo`](../interfaces/CAT20TokenInfo.md)\<[`OpenMinterCAT20Meta`](../interfaces/OpenMinterCAT20Meta.md)\> & `object`\>
