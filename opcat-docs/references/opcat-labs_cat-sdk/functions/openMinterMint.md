...
[cat-sdk](../README.md) / openMinterMint

# Function: openMinterMint()

> **openMinterMint**(`signer`, `preminerSigner`, `provider`, `minterUtxo`, `tokenId`, `metadata`, `tokenReceiver`, `changeAddress`, `feeRate`): `Promise`\<\{ `mintPsbt`: `ExtPsbt`; `mintTxid`: `string`; \}\>
