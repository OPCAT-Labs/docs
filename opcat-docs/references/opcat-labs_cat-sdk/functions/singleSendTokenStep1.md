...
[@opcat-labs/cat-sdk](../README.md) / singleSendTokenStep1

# Function: singleSendTokenStep1()

> **singleSendTokenStep1**(`provider`, `feeUtxos`, `inputTokenUtxos`, `receivers`, `feeChangeAddress`, `tokenChangeAddress`, `feeRate`): `Promise`\<\{ `changeTokenOutputIndex`: `number`; `guard`: [`CAT20Guard`](../classes/CAT20Guard.md); `guardPsbt`: `ExtPsbt`; `outputTokenStates`: [`CAT20State`](../type-aliases/CAT20State.md)[]; \}\>
