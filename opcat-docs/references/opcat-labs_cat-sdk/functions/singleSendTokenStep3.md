...
[@opcat-labs/cat-sdk](../README.md) / singleSendTokenStep3

# Function: singleSendTokenStep3()

> **singleSendTokenStep3**(`provider`, `finalizedGuardPsbt`, `finalizedSendPsbt`, `outputTokenStates`): `Promise`\<\{ `newCAT20Utxos`: `ExtUtxo`[]; `newFeeUtxo`: `UTXO`; \}\>
