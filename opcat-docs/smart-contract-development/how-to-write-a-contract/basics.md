...
All types can be imported from `@opcat-labs/scrypt-ts-opcat` package:
...
Bitcoin Virtual Machine does not allow unbounded loops for security reasons (eg: to prevent DoS attacks).
